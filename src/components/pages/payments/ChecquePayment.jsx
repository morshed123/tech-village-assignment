...
const ChecquePayment = (props) => {
    return (
        <div>
            <h5 className="text-center">Checque Payment</h5>
            <form action="" className="customer__form">
                ...
                <div className="row mb-3">
                    <div className="col-sm-12">
                        <input type="text" className="form-control form-control-sm txt__label" placeholder="Checque Number" />
                    </div>
                </div>
                <div className="row mb-3">
                    <div className="col-sm-12">
                        <input type="text" className="form-control form-control-sm txt__label" placeholder="Checque Expire Date" />
                    </div>
                </div>
                <div className="row mb-3">
                    <div className="col-sm-12">
                        <select className="form-select form-select-sm txt__label">
                            <option selected>Checque Select</option>
