...
const CardPayment = (props) => {
    return (
        <div>
            <h5 className="text-center">Card Payment</h5>
            <form action="" className="customer__form">
                ...
                <div className="row mb-3">
                    <div className="col-sm-12">
                        <input type="text" className="form-control form-control-sm txt__label" placeholder="Card Number" />
                    </div>
                </div>
                <div className="row mb-3">
                    <div className="col-sm-12">
                        <input type="text" className="form-control form-control-sm txt__label" placeholder="Card Expire Date" />
                    </div>
                </div>
                <div className="row mb-3">
                    <div className="col-sm-12">
                        <select className="form-select form-select-sm txt__label">
                            <option selected>Card Select</option>
